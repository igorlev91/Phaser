...
bool ULobby::Initialize()
{
    ...
    this->LobbyGameMode = UCandyChaosLoobyBlueprintLibrary::GetLobbyGameMode(this);
...
void ULobby::ShowOrHideButton() {
    ...
    if (this->ReadyButton && this->PreviousMap && this->NextMap) {
        ...
        if (!UCandyChaosLoobyBlueprintLibrary::IsServer(this)) {
...
{
    UUserWidget* ChatWindowUserWidget = UCandyChaosLoobyBlueprintLibrary::CreateAndShowWidget(this, this->ChatWindowClass, false, true);
...
FConfigurationMaps* ULobby::GetCurrentMapByName(FString Name)
{
    ...
    {
        FConfigurationMaps* DefaultMap = this->CandyChaosLobbyGameInstance->ConfigurationMaps.Find(Name);
...
FConfigurationMaps ULobby::GetFirstOrLastMap(bool bIsFirst)
{
    ...
    this->CandyChaosLobbyGameInstance->ConfigurationMaps.GenerateValueArray(ConfigurationDataArray);
...
FConfigurationMaps* ULobby::GetPreviousNextMap(bool IsIncrement)
{
    ...
    for (TPair<FString, FConfigurationMaps> Map : this->CandyChaosLobbyGameInstance->ConfigurationMaps)
    {
