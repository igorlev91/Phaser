...
void ARMainMenuController::OpenLoadingScreen(int whichLoadingScreen) // 0 is user login, 1 is login successful, 2 is creating session
{
	if (MenuUI)
	{
		MenuUI->OpenLoadingScreen(whichLoadingScreen);
	}
}

void ARMainMenuController::CreateLoadingScreenUI()
{
