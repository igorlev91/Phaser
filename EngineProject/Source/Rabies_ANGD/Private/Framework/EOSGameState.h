...
public:
	...
	URCharacterDefination* SecretCharacter;
	
private:

	UFUNCTION() // this function calls on both server and client if it's called from the server.
	void ShowSettings();
	...
	FTimerHandle ShowSettingsGameTimer;
